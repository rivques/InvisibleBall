...
BAKKESMOD_PLUGIN(InvisibleBall, "write a plugin description here", plugin_version, PLUGINTYPE_FREEPLAY)
...
void InvisibleBall::onLoad()
{
	...
	// cvarManager->registerNotifier("InvisibleBall_RequestBall", 
...
void InvisibleBall::RequestBall()
{
